      ...
      <Container>
        <Reveal>
          <div className="relative overflow-hidden rounded-[2.5rem] bg-ink px-6 py-16 text-center sm:px-12 sm:py-24">
            <div
              aria-hidden="true"
              className="pointer-events-none absolute -top-32 left-1/2 h-[420px] w-[420px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(255,90,54,0.35)_0%,transparent_70%)] blur-2xl"
            />
            <div className="relative">
              ...
              <div className="mt-9 flex justify-center">
                <a
                  ...
                  className="group inline-flex items-center gap-2 rounded-full bg-accent px-8 py-4 text-base font-medium text-ink transition-transform duration-300 hover:scale-[1.03] active:scale-[0.98]"
                >
